...
- **Аналитика в реальном времени** для принятия решений
...
4. **API для интеграции (для тестирования)**
...
1. **Actor**: Банковское приложение клиента
...
1. **Actor**: Внешняя система мониторинга
...
|-----------|------------|------------|-------------|
| **Data Collector** | Генерация транзакций | pymongo | MongoDB |
